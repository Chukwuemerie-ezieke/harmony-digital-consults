...
(function () {
  ...
  // Accept any code with one of these prefixes that's also in ACCESS_CODES above.
  ...
  function renderCertSection(percent) {
    ...
    mount.innerHTML = `
      <div class="hl-callout" style="border-color:#16a34a;background:#f0fdf4;margin-top:24px;">
        ...
        <p style="margin-top:8px;font-size:0.9rem;color:#475569;">Score recorded: ${percent}% &middot; HDT-208 &middot; ${new Date().toLocaleDateString()}</p>
      </div>
    `;
...
<body>
  <div class="cert">
    <div class="cert__seal">HARMONY<br>VERIFIED<br>HDT-208</div>
